...
SList<T, K>::SList() :
    ...
    m_pCursor( NULL )   
{
// For some reason prefix thinks this critsec is being leaked, even though
// the destructor cleans it up, as I've verified in the debugger.
#ifdef _PREFAST_
    #pragma prefast(suppress:15)
#endif
