param ($ConfigurationLocation ,[switch]$NoWarning)
...
$installDir = $ConfigurationLocation  #$global:dsTabExpansion.tables['Config'].select("Name = 'InstallPath'")[0].value
$DatabaseName = $global:dsTabExpansion.tables['Config'].select("Name = 'DatabaseName'")[0].value
$DatabasePath = $ConfigurationLocation   #$global:dsTabExpansion.tables['Config'].select("Name = 'DatabasePath'")[0].value
